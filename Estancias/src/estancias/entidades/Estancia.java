...
private LocalDate fecha_hasta;
    ...
    public Estancia(int id_estancia, int id_cliente, int id_casa, String nombre_huesped, LocalDate fecha_desde, LocalDate fecha_hasta) {
    ...
    public String toString() {
        return "Estancia ID: " + id_estancia + ", Cliente ID: " + id_cliente + ", Casa ID: " + id_casa 
                + "\nHuesped: " + nombre_huesped + ", desde " + fecha_desde + ", hasta " + fecha_hasta;
    }
